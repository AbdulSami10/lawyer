...
function App() {
  ...
  return (
    <main>
        ...
        <div className="flex items-center w-[100%] max-w-[1248px] p-5 justify-between">
          ...
          <div>
            <ul className='flex items-center text-white gap-5'>
              ...
              <li><a className='hover:text-[#dec985]' href="">Practice Areas</a></li>
              <li><a className='hover:text-[#dec985]' href="">Our firm</a></li>
              <li><a className='hover:text-[#dec985]' href="">Contact</a></li>
            </ul>
          </div>
        </div>
      </header>
      <div className='h-[90vh] bg-top relative' style={{backgroundImage: "url(/images/lawyers.avif)", backgroundPositionY: '15%'}}>
        <div className="absolute w-[100%] h-[100%] bg-black opacity-40">
        </div>
        <div className='h-[100%] w-[100%] pt-[25rem] p-10 text-white relative z-40 text-6xl max-w-[30rem]'>
          <div className='font-bebas border-b border-b-[#dec985] pb-3'>
      ...
      {/*<div className='p-10'>
        <h2 className='text-5xl font-bebas mb-10 text-center'>LEGAL SERVICES</h2>
        <div className='flex justify-center'>
          <div className="max-w-[968px] p-3 flex border border-gray-500  rounded-full justify-center items-center gap-10">
            <div className='w-[50%]'>
              <div>
                <img src="/images/litigation.webp" />
              </div>
              <h3 className='text-xl mt-5 font-bold'>Litigation</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. In et elementum mauris. Maecenas suscipit tincidunt dapibus. Mauris massa erat, sodales non pharetra .
              </p>
            </div>

            <div className='w-[50%]'>
              <div>
                <img src="/images/mergers.webp" />
              </div>
              <h3 className='text-xl mt-5 font-bold'>Mergers and Acquisitions</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. In et elementum mauris. Maecenas suscipit tincidunt dapibus. Mauris massa erat, sodales non pharetra.
              </p>
            </div>
  ...
  */}
    ...
    <div className='relative bg-cover bg-center' style={{backgroundImage: 'url(/images/cidade.jpg)'}}>
      <div className="absolute bg-black w-[100%] h-[100%] opacity-70"></div>
        <div className='p-10 pb-20 mx-auto max-w-[968px] relative z-10'>
          <h3 className='text-center text-6xl text-white mb-10'>CONTACT</h3>
          <div className="flex">

            <div className="flex flex-wrap gap-10 w-[50%] text-white">
                <div>
            ...
            <div className="w-[50%]">
              <form action="">
                <div className="flex flex-wrap items-center gap-4 justify-between">
                  <input name='name' className='bg-white outline-none placeholder-gray-700 block p-3 py-2' placeholder='First Name *' />
                  <input name='last_name' className='bg-white outline-none placeholder-gray-700 block p-3 py-2' placeholder='Last Name *' />
                </div>
                <div className="flex flex-wrap items-center gap-4 mt-5 justify-between">
                  <input name='email' type='email' className='bg-white outline-none placeholder-gray-700 block p-3 py-2' placeholder='E-mail address *' />
                  <input name='phone' type='tel' className='bg-white outline-none placeholder-gray-700 block p-3 py-2' placeholder='Phone *' />
                </div>
                ...
                <div className='flex justify-center'>
                  <button className='hover:bg-black hover:opacity-70 border border-[#cfa51b] rounded-sm transition uppercase bg-[#cfa51b] text-[15pt] text-white mt-3 p-3 py-2'>Submit</button>
                </div>
